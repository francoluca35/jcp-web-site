        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button size="lg" variant="outline" className="text-white border-2 border-[#ff6b35] hover:bg-[#ff6b35] hover:text-white font-bold px-8 py-4 rounded-lg transition-all duration-300 text-lg">
